xsim bin/tx4b_rx4b/test_rmii_tx4b_rx4b.xe  --max-cycles 500000 \
 --trace-plugin VcdPlugin.dll '-tile tile[0] -o trace.vcd -xe bin/tx4b_rx4b/test_rmii_tx4b_rx4b.xe -ports -ports-detailed -cores -instructions -clock-blocks' \
