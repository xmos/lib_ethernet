...
macro(set_app_tx_width)
    ...
    elseif(tx_width MATCHES "^8b_")
        string(REPLACE "_" ";" parts ${tx_width})
        list(GET parts 0 width)
        list(GET parts 1 bit0_pos)
        list(GET parts 2 bit1_pos)
        list(APPEND APP_COMPILER_FLAGS_${config} -DTX_WIDTH=8 -DTX8_BIT_0=${bit0_pos} -DTX8_BIT_1=${bit1_pos})
    endif()
endmacro()
