...
def do_test(impl, clk, phy):
    ...
    packets = [
        MiiPacket(dst_mac_addr=dut_mac_address, create_data_args=['step', (1, 72)]),
        MiiPacket(dst_mac_addr=dut_mac_address, create_data_args=['step', (5, 52)], inter_frame_gap=packet_processing_time(72)),
        MiiPacket(dst_mac_addr=dut_mac_address, create_data_args=['step', (7, 1500)], inter_frame_gap=packet_processing_time(52))
      ]
